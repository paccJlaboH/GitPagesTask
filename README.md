...
* **Система контролю версій (Version Control System / VCS)** — це програмне забезпечення, яке фіксує зміни у файлах проекту з перебігом часу, дозволяючи повертатися до попередніх станiв, аналізувати історію редагувань та ефективно організовувати командну розробку.
...
## 4. Сертифікат про проходження курсу

![Сертифікат з курсу Git](certificate.jpg)

> *Примітка: Файл сертифіката розміщений у корені репозиторію під назвою `certificate.jpg` (або у папці `images/`).*

---

## 5. Корисні джерела та лінки

* 📚 [Pro Git Book (Офіційна книга українською)](https://git-scm.com/book/uk/v2)
* 🎮 [Learn Git Branching (Інтерактивний тренажер гілок)](https://learngitbranching.js.org/?locale=uk)
* 📖 [Офіційна документація GitHub Docs](https://docs.github.com/)
* 🛠 [Cheat Sheet з команд Git від GitHub](https://education.github.com/git-cheat-sheet-education.pdf)
